...
def runLSTM():
    ...
    while isAgain == True:
        try:
            ...
            #  1.50->25 neurons doesn't help (overfitting was suspected)
            #**2.50->100 neurons helps (underfitting was suspected)
            ...
            lstm_model.fit(X_train, y_train, epochs=30, batch_size=24, verbose=0) 
